...
insert into Class (ClassCode, HeadTeacher, Room, TimeSlot, CloseDate)
	values
		('T2109M', 'Dang Kim Thi', 'LM81', 'G', '20220315 12:00:00'),
		('T2108M', 'Dang Kim Thi 2', 'LM80', 'I', '20220215 12:00:00'),
		('T2107M', 'Dang Kim Thi 3', 'LM79', 'L', '20220115 12:00:00'),
		('T2106M', 'Dang Kim Thi 4', 'LM78', 'M', '20220115 12:00:00'),
		('T2105M', 'Dang Kim Thi 5', 'LM77', 'G', '20211215 12:00:00')
insert into Student (RollNo, ClassCode, FullName, Male, BirthDate, Address, Provice, Email)
	values
		('DQTH2101M', 'T2109M', 'Dinh Quang Anh', 1, '19990711 08:30:00', 'Nho Quan, Ninh Binh', 'NB', 'qa1@gmail.com'),
		('DQTH2102M', 'T2108M', 'Dinh Quang Anh 2', 0, '19990811 08:30:00', 'Gia Vien, Ninh Binh', 'HN', 'qa2@gmail.com'),
		('DQTH2103M', 'T2107M', 'Dinh Quang Anh 3', 1, '19990911 08:30:00', 'Yen Khanh, Ninh Binh', 'BN', 'qa3@gmail.com'),
		('DQTH2104M', 'T2106M', 'Dinh Quang Anh 4', 0, '19991011 08:30:00', 'Yen Mo, Ninh Binh', 'HP', 'qa4@gmail.com'),
		('DQTH2105M', 'T2105M', 'Dinh Quang Anh 5', 1, '19991111 08:30:00', 'Hoa Lu, Ninh Binh', 'ND', 'qa5@gmail.com')
